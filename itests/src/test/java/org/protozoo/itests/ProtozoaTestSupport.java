...
public class ProtozoaTestSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProtozoaTestSupport.class);

    @Rule
    public ProtozoaTestWatcher baseTestWatcher = new ProtozoaTestWatcher();
     ...
     * uninstalling a single feature. So we need to make sure we uninstall all
     * features that were newly installed.
     *
